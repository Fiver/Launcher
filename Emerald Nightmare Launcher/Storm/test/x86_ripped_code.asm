...
SFileDecryptMpqHeader proc near         ;
CODE XREF:
sub_6D00E0+AEp
;
sub_6D00E0+D3p
                  ...
                  pbMpqHeader     = dword ptr -4
                                    pMpqHeader      = dword ptr  8
                                            dwSize          = dword ptr  0Ch
                                                    ...
                                                    mov     ebp, esp
                                                    push    ecx
                                                    mov     eax, [ebp+pMpqHeader] ;
EAX = MPQ Header
      push    ebx
      mov     ebx, [ebp+dwSize] ;
EBX - size of MPQ Header
push    esi
push    edi
mov     esi, ecx        ;
ESI - decryption buffer (6 DWORDs)
mov     edi, [esi]
shr     edi, 3
and     edi, 3Fh
...
sub_6D0210      proc near               ;
CODE XREF:
SFileVerifyMpqHeaderMD5+42p
;
sub_6D2D60+A9p ...
...
SFileVerifyMpqHeaderMD5 proc near    ;
CODE XREF:
SFileVerifyMpqHeader+6Bp
