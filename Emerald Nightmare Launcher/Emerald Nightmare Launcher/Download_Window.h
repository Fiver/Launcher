...
#pragma region Windows Form Designer generated code
		...
		this->button1->Click += gcnew System::EventHandler(this, &Download_Window::button1_Click);
		// 
		// label1
		// 
		...
		this->button2->Click += gcnew System::EventHandler(this, &Download_Window::button2_Click);
		// 
		// button3
		// 
		...
		this->button3->Click += gcnew System::EventHandler(this, &Download_Window::button3_Click);
		// 
		// Download_Window
		// 
