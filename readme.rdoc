...
THIS IS NOT COMPLETE, but almost there. Stormproxy can't repack patches, yet - Launcher interface can't edit Marforius-Client server lists, yet. (Two missing features)
...
http://suxorz.com/i5/untitlzoz.png
